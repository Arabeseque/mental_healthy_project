...
<template>
  <div h-100vh relative class="bg-[#CAEDEB]">
    <div
      py-2 w-full class="bg-[#CAEDEB]" absolute
      top-0 left-0 pl-30 pr-30
      inline-block flex justify-between items-center
    >
      <a href=""><div font-black text-5xl>logo</div></a>
